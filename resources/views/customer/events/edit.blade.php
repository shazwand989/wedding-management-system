...
<section class="content">
    <div class="container-fluid">
        <form action="{{ route('customer.events.update', $event->id) }}" method="POST">
            @csrf
            @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('event_type') is-invalid @enderror"
                                    ...
                                    <option value="Engagement" {{ old('event_type', $event->event_type) == 'Engagement' ? 'selected' : '' }}>Engagement</option>
                                    <option value="Reception" {{ old('event_type', $event->event_type) == 'Reception' ? 'selected' : '' }}>Reception</option>
                                    <option value="Rehearsal Dinner" {{ old('event_type', $event->event_type) == 'Rehearsal Dinner' ? 'selected' : '' }}>Rehearsal Dinner</option>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="booking_id" name="booking_id">
                                    ...
                                    @foreach($bookings as $booking)
                                        <option value="{{ $booking->id }}" {{ old('booking_id', $event->booking_id) == $booking->id ? 'selected' : '' }}>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('venue_address') is-invalid @enderror"
                                          id="venue_address" name="venue_address" rows="3" required>{{ old('venue_address', $event->venue_address) }}</textarea>
                                @error('venue_address')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control" id="venue_google_maps"
                                       name="venue_google_maps" value="{{ old('venue_google_maps', $event->venue_google_maps) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="special_instructions"
                                          name="special_instructions" rows="3">{{ old('special_instructions', $event->special_instructions) }}</textarea>
                ...
                <div class="col-md-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="max_guests"
                                       name="max_guests" value="{{ old('max_guests', $event->max_guests) }}" min="1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" id="rsvp_deadline"
                                       name="rsvp_deadline" value="{{ old('rsvp_deadline', $event->rsvp_deadline ? $event->rsvp_deadline->format('Y-m-d') : '') }}">
                            </div>

                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="allow_plus_one"
                                           name="allow_plus_one" value="1" {{ old('allow_plus_one', $event->allow_plus_one) ? 'checked' : '' }}>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ route('customer.events.show', $event->id) }}" class="btn btn-secondary w-100 mt-2">
