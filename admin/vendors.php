...
<script>
    ...
    `);
        ...
        $.ajax({
            ...
            .done(function(data) {
                if (data.success) {
                    $vendorDetails.html(data.html);

                    // Re-enable normal closing behavior (Bootstrap 4 way: hide & re-init)
                    $vendorModal.data('bs.modal')._config.backdrop = true;
                    $vendorModal.data('bs.modal')._config.keyboard = true;
                } else {
                    $vendorDetails.html(`
