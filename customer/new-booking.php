...
<head>
    ...
    <title>New Booking - <?php echo SITE_NAME; ?></title>
...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="new-booking.php" class="active"><i class="fas fa-plus"></i> New Booking</a></li>
    ...
    <div class="main-content">
        ...
        <div style="margin-bottom: 2rem; padding-bottom: 1rem; border-bottom: 1px solid var(--border-color);">
            <h1 style="margin: 0; color: var(--primary-color);">Create New Booking</h1>
            <p style="margin: 0; color: #666;">Plan your perfect wedding with us</p>
        </div>
